...
import CommentBox from './components/commentBox';  // 引入CommentBox组件
      ...
      <div className="relative z-30">
        ...
        <main className={styles.main}>
          ...
          <div className={styles.grid}>
            ...
            <a href="#idoSection" className={styles.card}>
              <h2>Get $AZUKI</h2>
              <p>
          ...
          <section id="idoSection" className={`${styles.section} mt-20 text-center`}>
          ...
          <section  className="idoSection">
            <div className="idoText">
              <h2 className="idotitle">IDO Rules:</h2>
              <p>Please make sure you send between 0.02-0.5 ETH, If you send less than 0.02ETH, it will not be returned</p>
            </div>
