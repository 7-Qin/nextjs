...
function Roadmap() {
    ...
    return (
        ...
        <h2 className="idotitle text-center">Roadmap</h2>
            ...
            <div className="relative wrap overflow-hidden p-10 h-full">
              ...
              <div className="mb-8 flex justify-between items-center w-full right-timeline">
                ...
                <div className="order-1 bg-gray-400 rounded-lg shadow-xl w-5/12 px-6 py-4">
                  <h3 className="mb-3 font-bold text-gray-800 text-xl">July 2023</h3>
                  <p className="text-sm leading-snug tracking-wide text-gray-900 text-opacity-100">Release airdrop</p>
                  <p className="text-sm leading-snug tracking-wide text-gray-900 text-opacity-100">Launch DEX</p>
                  {/* <p className="text-sm leading-snug tracking-wide text-gray-900 text-opacity-100">Complete testing of the game on the ETH Testnet</p> */}
                  <p className="text-sm leading-snug tracking-wide text-gray-900 text-opacity-100">Complete testing of the game on the test chain and release points rewards and airdrops</p>
                </div>
              </div>
